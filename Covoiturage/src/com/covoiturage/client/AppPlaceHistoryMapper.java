...
@WithTokenizers({LoginPlace.Tokenizer.class, MapPlace.Tokenizer.class,AddUserPlace.Tokenizer.class,ValidatePassengersPlace.Tokenizer.class, SettingsPlace.Tokenizer.class})
